...
class InputListener implements View.OnTouchListener {
    ...
    /**
     * Previous horizontal position point.
     */
    private float previousX;
    /**
     * Previous vertical position point.
     */
    ...
    InputListener(Main2048View view) {
        super();
        this.mView = view;
    }

    /**
     * Making movements on the grid according to the user swipe motion.
     */
    ...
    /**
     * The length of the swipe movement.
     */
    ...
    /**
     * Returns whether an icon has been pressed.
     */
    ...
    /**
     * Returns whether the swipe was in range.
     */
    ...
    /**
     * Returns whether a tap has occurred.
     */
